...
public class Grupo7 {
    ...
    final char JUGADOR_CPU_O = JUGADOR_O;
    ...
    public char[][] clonarMatriz(char[][] tableroOriginal) {
        ...
        for (int y = 0; y < FILAS; y++) {
            System.arraycopy(tableroOriginal[y], 0, copia[y], 0, COLUMNAS);
        }
        return copia;
    }
    ...
    /*
     * Funciones de conteo. Simplemente cuentan cuántas piezas del mismo jugador
     * están
     * alineadas
     */
    ...
    // Devuelve el jugador contrario al que se le pasa. Es decir, le das un O y te
    // devuelve el X
    ...
    // Devuelve las coordenadas en las que se puede ganar, o -1 y -1 si no se puede
    // ganar
    ...
    /*
     * Esta función cuenta y te dice el mayor puntaje, pero no te dice en cuál X ni
     * cuál Y. Está pensada
    ...
    /*
     * Esta función complementa a contarSinSaberCoordenadas. Te dice en qué X e Y el
     * jugador [jugador]
    ...
    public void iniciarJuego(int modo) {
        ...
        while (true) {
            ...
            if (modo == JUGADOR_JUGADOR || (modo == JUGADOR_CPU && jugadorActual == JUGADOR_X)) {
                ...
                // Al usuario se le solicitan números comenzando a contar en 1, pero en los
                // arreglos comenzamos desde el 0
                // así que necesitamos restar uno en ambas variables
                x--;
                y--;
            } else if (modo == CPU_CPU || jugadorActual == JUGADOR_CPU_O) {
                // Si es modo CPU contra CPU o es el turno del CPU, dejamos que las coordenadas
                // las elija
                // el programa
            ...
            // Sin importar cuál modo haya sido, colocamos la pieza según las coordenadas
            // elegidas

            colocarPieza(y, x, jugadorActual, tablero);
            // Puede que después de colocar la pieza el jugador gane o haya un empate, así
            // que comprobamos
